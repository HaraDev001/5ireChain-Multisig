...
use sp_runtime::{
	...
	traits::{Extrinsic as ExtrinsicT, IdentityLookup, Zero},
};
...
frame_support::construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		EsgPallet: esg_fetcher::{Pallet, Call, Storage, Event<T>},
...
impl AppCrypto<UintAuthorityId, TestSignature> for AuthId {
...
impl esg_fetcher::Config for Test {
	type Event = Event;
...
impl crate::pallet::pallet::Config for Test {
	...
	type EsgData = esg_fetcher::ScoreProvider<Self>;
}
