...
use sp_runtime::{
	...
	traits::{
		self, AccountIdLookup, BlakeTwo256, Block as BlockT, Dispatchable, IdentifyAccount,
		NumberFor, OpaqueKeys, PostDispatchInfoOf, SaturatedConversion, Verify,
	},
...
pub use frame_support::{
	...
	traits::{
		EqualPrivilegeOnly, FindAuthor, KeyOwnerProofSystem, LockIdentifier, Randomness,
...
use runtime_common::{
	BlockHashCount, RuntimeBlockLength, RuntimeBlockWeights, SS58Prefix, NORMAL_DISPATCH_RATIO,
};
...
pub use evm_transfer;

/// import the offchain worker to fetch esg data
pub use esg_fetcher;

/// import nft functionality call
pub use nft_features;
...
mod precompiles;
pub use precompiles::FireChainPrecompiles;

pub type Precompiles = FireChainPrecompiles<Runtime>;
...
parameter_types! {
	...
	pub SignedRewardBase: Balance = DOLLARS;
...
parameter_types! {
	pub const ExistentialDeposit: u128 = MILLICENTS/1000;//10^9
	pub const MaxLocks: u32 = 1024;
	pub const MaxReserves: u32 = 2048;
}
...
impl pallet_evm::Config for Runtime {
	...
	type Precompiles = FireChainPrecompiles<Self>;
...
impl evm_transfer::Config for Runtime {
	type Event = Event;
	type AddressMapping = pallet_evm::HashedAddressMapping<BlakeTwo256>;
	type Currency = Balances;
}
...
impl pallet_nft::Config for Runtime {
	type ClassId = u32;
	type TokenId = u32;
	type ClassData = nft_features::ClassData<Balance>;
	type TokenData = nft_features::TokenData<Balance>;
...
// Schedule upgrade onchain
parameter_types! {
	pub MaximumSchedulerWeight: Weight = NORMAL_DISPATCH_RATIO * runtime_common::RuntimeBlockWeights::get().max_block;
...
parameter_types! {
	pub const AssetDeposit : Balance = MILLICENTS;
	pub const MetadataDepositBase: Balance = MILLICENTS;
	pub const MetadataDepositPerByte: Balance = MILLICENTS/1_000;
	pub const ApprovalDeposit :Balance = FIREB;
...
parameter_types! {
	pub ClassDepositBase: Balance = CENTS;
	pub TokenDepositBase: Balance = MILLICENTS;
	pub DataNftDepositPerByte : Balance = MILLICENTS;
	pub MaxDataBytes: u32 = 2048;
	pub NftFeaturesId: PalletId = PalletId(*b"5ire/Nft");

}

impl nft_features::Config for Runtime {
	type Event = Event;
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		// Offchain worker for fetching from the esg_oracle
		ESGFetcher: esg_fetcher::{Pallet, Call, Storage, Event<T>},
		//EVM
		EVM: pallet_evm::{Pallet, Config, Call, Storage, Event<T>},
		Ethereum: pallet_ethereum::{Pallet, Call, Storage, Event, Origin, Config} ,
		EvmTransfer: evm_transfer::{Pallet,Call, Storage,Event<T>},
		//NFT
		Nft: pallet_nft::{Pallet, Storage,Config<T>},
		NftFeatures: nft_features::{Pallet, Call, Storage, Event<T>},
		//Scheduler
